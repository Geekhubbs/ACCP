    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1 max-w-xl">
            Configure regional gateway parameters, automated routing thresholds,
            citizen notification channels, and statutory data protection
            policies.
          </p>
        </div>
      ...
      {activeTab !== "general" ? (
        <div className="rounded-xl border border-dashed border-slate-300 bg-slate-50 p-10 text-center text-sm text-slate-500">
          {settingsTabs.find((t) => t.id === activeTab)?.label} controls go here
          — not built yet.
        </div>
      ) : (
        <>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="rounded-lg border border-rose-200 bg-rose-50 p-3">
                    ...
                    <p className="text-xs text-slate-600 mt-1">
                      Emergency SLA — flash floods, fallen mains, road collapse
                    </p>
